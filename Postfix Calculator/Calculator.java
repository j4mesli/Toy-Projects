...
public class Calculator {
	...
	public static void main(String[] args) {
	    ...
	    myPanel.add(new JLabel("Infix Expression: "));
	    myPanel.add(input);
	    int result = JOptionPane.showConfirmDialog(null, myPanel,"Enter your infix expression here: ", JOptionPane.OK_CANCEL_OPTION);
	    if (result == JOptionPane.OK_OPTION) {
	    	infix = input.getText();
	    }
	    else {
	    	JOptionPane.showMessageDialog(null, "OPERATION CANCELLLED!");
	    	System.exit(0);
	    }
		...
		JOptionPane.showMessageDialog(null, "Infix: "+infix+"\nPOSTFIX: "+ postfix + "\nANSWER: " + calculate(postfix.replace(" ", "")));
	}
}
class Converter {
